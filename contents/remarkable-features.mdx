...
<div style={{ display: "flex" }}>
  <img width="33%" src="/bar-chart.png" className="rounded" />
  <img width="33%" src="/line-chart.png" className="ml-1 rounded" />
</div>
...
<img width="77%" src="/mermaid-sample.png" className="rounded" />
...
<img width="77%" src="/katex-sample.png" className="rounded" />
...
<img width="48%" src="/pomodoro-dialog-sample.png" className="rounded" />
