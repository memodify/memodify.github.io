...
<img width="66%" src="/mdx.png" loading="lazy" />
...
<div style={{ display: "flex" }}>
  <img width="33%" src="/bar-chart.png" className="rounded" loading="lazy" />
  <img width="33%" src="/line-chart.png" className="ml-1 rounded" loading="lazy" />
</div>
...
<img width="77%" src="/mermaid-sample.png" className="rounded" loading="lazy" />
...
<img width="77%" src="/katex-sample.png" className="rounded" loading="lazy" />
...
<img width="66%" src="/focus-command-palette.png" loading="lazy" />

### Note palette

You can focus on a note with note palette. It's activated with `command + p`.

<img width="66%" src="/note-palette.png" loading="lazy" />
...
<img width="48%" src="/pomodoro-dialog-sample.png" className="rounded" loading="lazy" />
